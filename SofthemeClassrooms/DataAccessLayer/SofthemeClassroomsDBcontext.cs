namespace DataAccessLayer
{
    ...
    public partial class SofthemeClassroomsDBcontext : DbContext
    {
        public SofthemeClassroomsDBcontext()
            : base("name=SofthemeClassroomsDBcontext")
        {
        }
        ...
        public virtual DbSet<ClassRoomProperties> ClassRoomProperties { get; set; }
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ClassRooms>()
                .HasMany(e => e.ClassRoomProperties)
